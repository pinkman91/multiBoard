...
<head>
	...
	<style type="text/css">
	/* 여기에 스타일 추가 */
	table{width: 900px;margin: auto; border-radius: 10px;}
	th {padding: 5px; border: 1px solid gray; text-align: center;}
	td {padding: 5px; border: 1px solid gray;}
	.title {font-size: 18pt; text-align: center; border: none;}
	.sub_title {font-size: 10pt; text-align: right; border: none;}
	.subject:hover {
		background-color: fbfbfb;cursor: pointer;
	}
	.adminDelete{
		margin-left: 40px;
	}
...
<strong style="margin: 0 auto;">${user}</strong>님 환영합니다<br><br>
