...
// 생성자 : 계산되지 않고 결정해 주어야 하는것은 넘겨 받는다.
   ...
   //----------------------------------------------------------------------------------------------------
   // POST 전송
   public String getPageListPost() { //\"boardName\":\""+ boardName + 
      String pageList = "";
      if(totalPage>0) {
         pageList += "<ul class='pagination pagination-sm justify-content-center'>";
         // 시작페이지번호가 1보다 크다면 "이전"이 있다.
         if(startPage>1) { 
            pageList +="<li class='page-item'>";
            pageList +="<a class='page-link'  href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName +"\",tb\":\""+ tableName + "\",\"p\":\""+(1)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
            pageList +="처음";
            pageList +="</a>";
            pageList +="</li>";
            pageList +="<li class='page-item'>";
            pageList +="<a class='page-link'  href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(startPage-1)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
            pageList +="이전";
            pageList +="</a>";
            pageList +="</li>";
         }
         ...
         for(int i=startPage;i<=endPage;i++) {
            if(i==currentPage) {
               ...
               pageList += "<li class='page-item'>";
               pageList +="<a class='page-link' href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(i)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
               pageList += i;
               pageList +="</a>";
               pageList += "</li>";
            }
         ...
         if(endPage<totalPage) { 
            pageList +="<li class='page-item'>";
            pageList +="<a class='page-link'  href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(endPage+1)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
            pageList +="다음";
            pageList +="</a>";
            pageList +="</li>";
            pageList +="<li class='page-item'>";
            pageList +="<a class='page-link'  href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(totalPage)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
            pageList +=" 끝 ";
            pageList +="</a>";
            pageList +="</li>";
         }
   ...
   public String getPageTextListPost() {
      ...
      if(totalPage>0) {
         ...
         // 마지막페이지번호가 전체페이지수 보다 적다면 "다음"이 있다.
         if(endPage<totalPage) { 
            pageList +="[<a href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(endPage+1)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
            pageList +="다음] ";
            pageList +="</a>";
            pageList +="[<a href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(totalPage)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
            pageList +=" 끝 ]";
            pageList +="</a>";
         }
         pageList += "</ul>";
   ...
   public String getPageImageListPost() {
      ...
      if(totalPage>0) {
         ...
         // 시작페이지번호가 1보다 크다면 "이전"이 있다.
         if(startPage>1) { 
            pageList +="<a  href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(1)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
            pageList +="<img src='images/first18.png'>";
            pageList +="</a> ";
            pageList +="<a href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(startPage-1)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
         ...
         for(int i=startPage;i<=endPage;i++) {
            if(i==currentPage) {
               ...
               pageList +="[<a href='#' onclick='post_to_url(\"?\",{\"boardName\":\""+ boardName + "\",\"tb\":\""+ tableName + "\",\"p\":\""+(i)+"\",\"s\":\""+pageSize+"\",\"b\":\""+blockSize+"\"})'>";
               pageList += i;
               pageList +="</a>] ";
            }
         }
