...
<body>
	...
	<table style="border: 1px;text-align: center;">
		<tr>
			<td colspan="4" class="title">자유게시판 글수정</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="left" colspan="3">
				<input type="text" name="subject" id="subject" required="required" placeholder="제목입력" size="78" value="${vo.subject }">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="4" align="right" style="padding-right: 120px;">
				...
				<input type="button" value="취소하기" class="btn btn-outline-dark btn-sm"
				        onclick='post_to_url("view",{"tb":"${commVO.tableName}","idx":${vo.idx },"m":"0", "p":${commVO.currentPage },"s":${commVO.pageSize},"b":${commVO.blockSize },"boardName":"${commVO.boardName }"})'>
			</td>
		</tr>
	</table>
	</form>
